...
$template->assign_vars(array(  
  ...
  'REGEN' => $character_magelo_stats['hp_regen_item'],
  'REGEN_cap' => $character_magelo_stats['hp_regen_item_cap'],
  'FT' => $character_magelo_stats['mana_regen_item'],
  'FT_cap' => $character_magelo_stats['mana_regen_item_cap'],
  ...
  'STA' => $character_magelo_stats['STA_total'],
  'DEX' => $character_magelo_stats['DEX_total'],
  'AGI' => $character_magelo_stats['AGI_total'],
  'INT' => $character_magelo_stats['INT_total'],
  'WIS' => $character_magelo_stats['WIS_total'],
  'CHA' => $character_magelo_stats['CHA_total'],
  'POISON' => $character_magelo_stats['PR_total'],
  'FIRE' => $character_magelo_stats['FR_total'],
  'MAGIC' => $character_magelo_stats['MR_total'],
  'DISEASE' => $character_magelo_stats['DR_total'],
  'COLD' => $character_magelo_stats['CR_total'],
  'STR_cap' => $character_magelo_stats['STR_cap'],
  'STA_cap' => $character_magelo_stats['STA_cap'],
  'DEX_cap' => $character_magelo_stats['DEX_cap'],
  'AGI_cap' => $character_magelo_stats['AGI_cap'],
  'INT_cap' => $character_magelo_stats['INT_cap'],
  'WIS_cap' => $character_magelo_stats['WIS_cap'],
  'CHA_cap' => $character_magelo_stats['CHA_cap'],
  'POISON_cap' => $character_magelo_stats['PR_cap'],
  'FIRE_cap' => $character_magelo_stats['FR_cap'],
  'MAGIC_cap' => $character_magelo_stats['MR_cap'],
